@extends('layouts.app', [
'namePage' => 'editar Complemento',
'class' => 'sidebar-mini',
'activePage' => 'editarComplementos',
])
@section('content')
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h5 class="title">{{__(" Editar Complemento")}}</h5>
        </div>
        <div class="card-body">
				<form action="{{route('complemento.update', $complemento->id)}}" method="post" autocomplete="off">

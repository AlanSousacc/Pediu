          ...
          <div class="card-body">
            <div class="tab-content text-center">
              <div class="card-header row">
                <div class="col-md-6">
                  <h4 class="card-title text-left mt-0"> Pagamentos Geral</h4>
                </div>
                <div class="col-md-6 text-right">
                  <a href="{{route('movimentacao.show', 'saida')}}" class="btn btn-danger">Novo Pagamento</a>
                  <a href="{{route('movimentacao.pagamentos.dia')}}">Mostrar Pagamentos do Dia</a>
                </div>
              </div>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{$item->id}}" data-tipo="Pagar Restante" data-valtotal={{$item->valortotal}}
                              ...
                              <i class="ionicons ion-cash"></i> Pagar Restante
                            </a>
                            @endif
                          ...
                          <table class="table table-bordered mb-0">
                            <thead>
                              <tr>
                                ...
                                <th class="text-center" style="font-size: 15px; font-weight: 500">Forma Movimentação</th>
                                <th class="text-center" style="font-size: 15px; font-weight: 500">Total</th>
                                <th class="text-center" style="font-size: 15px; font-weight: 500">Pago</th>
              ...
              <div class="row">
                <div class="col-md-10 text-left">
                  <p>Mostrando {{$movimentacao->count()}} pagamentos de um total de: {{$movimentacao->total()}}</p>
                </div>

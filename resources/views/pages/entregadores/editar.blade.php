    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h5 class="title">{{__(" Editar Entregador")}}</h5>
        </div>
        <div class="card-body">
				<form action="{{route('entregador.update', $entregador->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">

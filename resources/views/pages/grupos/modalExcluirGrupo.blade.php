	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header bg-danger" style="text-align: center; display: inline;">
				...
				<h4 class="modal-title text-center m-0" style="color:#fff">Confirmação de exclusão</h4>
			</div>
			<form action="{{route('grupo.destroy', 'id')}}" method="post">
				{{method_field('delete')}}
				{{ csrf_field() }}
				<div class="modal-body">
					<p class="text-center">Você tem certeza que deseja excluir este Grupo?</p>
					<input type="hidden" name="grupo_id" id="contid" value="">
				</div>

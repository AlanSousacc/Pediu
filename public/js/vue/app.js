...
/* harmony import */ var vue_search_select_dist_VueSearchSelect_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-search-select/dist/VueSearchSelect.css */ "./node_modules/vue-search-select/dist/VueSearchSelect.css");
...
/* harmony import */ var vue_search_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! vue-search-select */ "./node_modules/vue-search-select/dist/VueSearchSelect.common.js");
/* harmony import */ var vue_search_select__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(vue_search_select__WEBPACK_IMPORTED_MODULE_4__);
Vue.component('modal-detalhe-item', __webpack_require__(/*! ./components/modalComplementos.js */ "./resources/js/vue/components/modalComplementos.js")["default"]);
...
Vue.component('vue-search-select', vue_search_select__WEBPACK_IMPORTED_MODULE_4__["ModelSelect"]);
new Vue({
  el: '#app',
  filters: {
  ...
  data: {
    ...
    itemsPedido: [],
    listagemContatos: [],
    //lista todos os contatos ativos na aba de contatos
    contatoId: null,
    contato: {
      text: '',
      value: ''
  ...
  methods: {
    consultaItem: _.debounce(function () {
      var vm = this;
      var url = $('meta[name=searchUrl]').attr('content');
      $.ajax({
        url: "".concat(url, "/").concat(this.search),
        type: "get",
        dataType: "json"
      }).done(function (resposta) {
        var data = resposta.data.produto;
        vm.items = data;
    ...
    getTaxaEntrega: function getTaxaEntrega() {
      var vm = this;
      var url = $('meta[name=getConfigEmpresa]').attr('content');
      $.ajax({
        url: "".concat(url),
        type: "get",
        dataType: "json"
      }).done(function (resposta) {
        var data = resposta.config.valorentrega;
    ...
    getContatos: function getContatos() {
      var vm = this;
      var url = $('meta[name=getContatos]').attr('content');
      $.ajax({
        url: "".concat(url),
        type: "get",
        dataType: "json"
      }).done(function (resposta) {
        var data = resposta.data.contatos;
    ...
    getItemsGroup: function getItemsGroup(id) {
      var vm = this;
      var url = $('meta[name=getItemFromGroup]').attr('content');
      $.ajax({
    ...
    getEnderecoCliente: function getEnderecoCliente(id) {
      var vm = this;
      var url = $('meta[name=getEnderecoCliente]').attr('content');
      $.ajax({
        url: "".concat(url, "/").concat(id),
        type: "get",
        dataType: "json"
      }).done(function (resposta) {
        var data = resposta.data.enderecos;
        vm.enderecosContato = data;
      }).fail(function (jqXHR, textStatus) {
        alert("Falha ao listar os dados: " + textStatus);
      });
    },
    openModalItem: function openModalItem(id) {
    ...
    calculaItems: function calculaItems() {
      var _this = this;

      this.totalItemsPedido = 0;
      this.totalMonetarioPedido = 0;
      this.itemsPedido.forEach(function (itempedido, index) {
        var calculoTotalItem = itempedido.preco * itempedido.qtde;
        _this.totalItemsPedido += itempedido.qtde;
        _this.totalMonetarioPedido += calculoTotalItem;
        _this.itemsPedido[index]['totalItemLista'] = calculoTotalItem;
      });
    },
    // lança item do modal a listagem de pedido serve também para edição
    lancarItem: function lancarItem(form) {
      this.showModal = false;
      this.details = null;
      ...
      var it = this.itemsPedido.find(function (item) {
        return item.iditemlista == form.iditemlista;
      });
    ...
    removeItem: function removeItem(id) {
      var itp = this.itemsPedido.find(function (item) {
        return item.iditemlista == id;
      });
    ...
    concluirPedido: function concluirPedido() {
      var _this2 = this;

      var vm = this;
      var url = $('meta[name=processaPedidoBalcao]').attr('content');
      var urlImprimir = $('meta[name=imprimir]').attr('content');
      $.ajaxSetup({
        headers: {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            ...
            type: "POST",
            data: {
              itemsPedido: _this2.itemsPedido,
              pagamento: _this2.pagamento,
              contato_id: _this2.contatoId,
              endereco_id: _this2.endereco_id,
              novocliente: _this2.novocliente
            },
            dataType: "json"
          }).done(function (response) {
            if (response.resposta.error) {
              Swal.fire('Falha ao Registrar Pedido', response.resposta.error, 'error');
              return;
            }
    ...
    editarPedido: function editarPedido(id) {
      var _this3 = this;

      var vm = this;
      var url = $('meta[name=editarPedido]').attr('content');
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("".concat(url, "/").concat(id)).then(function (resposta) {
        var data = resposta.data.pedido;
        vm.contato = resposta.data.pedido.contato_id;
        data.itenspedidos.forEach(function (itempedido) {
          data.complementositenspedido.forEach(function (complemento) {
            vm.adicionaisItem.push(complemento);
          });
          vm.itemsPedido.push(itempedido); // complemento.produto_id == itempedido.produto_id
        });
  ...
  computed: {
    calculaPedido: function calculaPedido() {
  ...
  mounted: function mounted() {
    ...
    setTimeout(function () {
      ...
      _this4.getTaxaEntrega();
    }, 700); // if($('#editId').val() != null){
...
/***/ "./resources/js/vue/components/modalComplementos.js":
/*!**********************************************************!*\
  !*** ./resources/js/vue/components/modalComplementos.js ***!
  \**********************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      configMeioaMeio: false,
      //Aqui vai receber o valor da configuração se o preço da pizza meio a meio é o produto base ou produto mais caro dos meio a meio
      sabores: [],
      saboresModel: [],
      //model
      itemsDiversos: [],
      //sabores diversos recebe todos os itens que são do grupo 1 (pizza)
      observacao: ''
    };
  },
  methods: {
    confirmDetailItem: function confirmDetailItem() {
      var adicionalCalc = 0;
      this.adicional.forEach(function (adc) {
    ...
    getItemsPizza: function getItemsPizza() {
      var vm = this;
      var url = $('meta[name=getItemsPizza]').attr('content');
      $.ajax({
        url: "".concat(url),
        type: "get",
        dataType: "json"
    ...
    getConfigMeioaMeio: function getConfigMeioaMeio() {
      var vm = this;
      var url = $('meta[name=getConfigEmpresa]').attr('content');
      $.ajax({
        url: "".concat(url),
        ...
        var data = resposta.config.maiorprecomeioameio;
        vm.configMeioaMeio = data == 1 ? true : false;
      }).fail(function (jqXHR, textStatus) {});
    },
    getAdicionais: function getAdicionais(id) {
      this.complementos[id] = !this.complementos[id] || false;
    },
    checkAdicional: function checkAdicional(complemento) {
      var comp = document.querySelector('#complemento' + complemento.id);
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this.multipleCancelButton = new Choices('#choices-multiple-remove-button', {
                removeItemButton: true,
                maxItemCount: 4,
                searchResultLimit: 4,
                renderChoiceLimit: 4
              });
              _this.tamanho = _this.item.controlatamanho ? 'precomedio' : 'precovenda';
              _context.next = 4;
              return _this.getItemsPizza();

            case 4:
              // obtem a configuração do item meio a meio
              _this.getConfigMeioaMeio();

              if (_this.details) {
                _this.qtde = _this.details.qtde;
                _this.iditemlista = _this.details.iditemlista;
                _this.tamanho = _this.details.tamanho;
                _this.observacao = _this.details.observacao;
                _this.adicional = _this.details.adicional;
                _this.sabores = _this.details.sabores;

                _this.details.adicional.forEach(function (adicional) {
                  document.querySelector('#complemento' + adicional.id).checked = true;
                });

                _this.details.sabores.forEach(function (sabor) {
                  _this.saboresModel.push(sabor.id);
                });

                _this.multipleCancelButton.setChoices(_this.details.sabores.map(function (sabor) {
                  return {
  ...
  watch: {
    ...
    itemsDiversos: function itemsDiversos() {
      var _this2 = this;

      this.multipleCancelButton.setChoices(this.itemsDiversos.map(function (it) {
        var selected = false;

        if (_this2.item.id == it.id) {
          _this2.saboresModel.push(_this2.item.id);
    ...
    saboresModel: function saboresModel() {
      var _this3 = this;

      var ids = Object.values(this.saboresModel);
      this.sabores = this.itemsDiversos.filter(function (it) {
        return ids.includes(it.id) && it.id != _this3.item.id;
      });

      if (this.configMeioaMeio) {
        var maiorPreco = this.item[this.tamanho];
        this.sabores.forEach(function (sabor) {
          maiorPreco = sabor[_this3.tamanho] > maiorPreco ? sabor[_this3.tamanho] : maiorPreco;
        });
